      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.policySection}>
          <View style={styles.policyItem}>
            <Icon name="security" size={20} color={appColors.blue} style={styles.policyIcon} />
          ...
          <View style={styles.policyItem}>
            <Icon name="how-to-reg" size={20} color={appColors.blue} style={styles.policyIcon} />
            <View style={styles.policyTextContainer}>
          ...
          <View style={styles.policyItem}>
            <Icon name="share" size={20} color={appColors.blue} style={styles.policyIcon} />
            <View style={styles.policyTextContainer}>
          ...
          <View style={styles.policyItem}>
            <Icon name="lock" size={20} color={appColors.blue} style={styles.policyIcon} />
            <View style={styles.policyTextContainer}>
          ...
          <View style={[styles.policyItem,{borderBottomWidth:0}]}>
            <Icon name="edit" size={20} color={appColors.blue} style={styles.policyIcon} />
            <View style={styles.policyTextContainer}>
