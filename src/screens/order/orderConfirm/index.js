...
const OrderConfirmation = ({ navigation }) => {
  ...
  const orderDetails = {
    ...
    items: [
      { id: 1, name: 'Shirts (Man)', quantity: 2, service: 'Wash & Iron', price: 20 },
      { id: 2, name: 'Trouser (Man)', quantity: 3, service: 'Wash & Iron', price: 25 },
      { id: 3, name: 'Jeans (Man)', quantity: 1, service: 'Wash & Fold', price: 10 },
      { id: 4, name: 'T-shirt (Woman)', quantity: 2, service: 'Wash & Iron', price: 18 },
    ],
    subTotal: 73,
    tax: 5,
    total: 78,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.statusCard}>
        <View style={styles.progressCircle}>
          <Icon name="clipboard-check-outline" size={30} color={appColors.blue} />
        </View>
    
        <View style={{ marginLeft: 16 }}>
          <Text style={styles.statusLabel}>Order Status</Text>
          <Text style={styles.statusValue}>Order Confirmed</Text>
          <Text style={styles.orderDate}>25 June 2025</Text>
        </View>
      </View>
